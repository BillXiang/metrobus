...
public class DetailBusLineActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case MENU_LIKE:
			...
			break;
		case MENU_LOCATE:
			BusUserManager.getInstance(UserFragment.userName).requestBusPosition(this, busId, new BusLineSearchHanlder());
			...
			BusUserManager.getInstance(UserFragment.userName).getOn(busId);
			finish();
			break;
		case MENU_GETON:
			FragmentTabsPager.tabsAdapter.navigateTo("nearby");
