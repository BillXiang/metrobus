...
public class UserFragment extends Fragment {
	 ...
	 */
	public static final String AUTHORITY = "com.bill.metrobus.LoaderThrottle";
	...
	public static class SimpleProvider extends ContentProvider {
		...
		public int delete(Uri uri, String where, String[] whereArgs) {
			...
			case MAIN_ID:
				...
				finalWhere = DatabaseUtilsCompat.concatenateWhere(MainTable._ID
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.userview, container, false);
	}
}