package com.bill.metrobus.QuickAction;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public QuickAction(Context context) {
		...
		mTrackAnim 	= AnimationUtils.loadAnimation(context, R.anim.coursetable_rail);
		...
		setRootViewId(R.layout.coursetable_quickaction);
	...
	public void addActionItem(ActionItem action) {
		...
		View container	= (View) inflater.inflate(R.layout.coursetable_action_item, null);
	...
	public void show (View anchor) {
		 ...
		 * QuickAction左上角x坐标
		 */
		xPos = anchorRect.left-(rootWidth-anchorRect.width())/2;
		...
		boolean onTop = true;
		// display on bottom
		if (rootHeight > location[1]- statusBarHeight) {//location[1]:View anchor相对屏幕的纵坐标
		 ...
		 * QuickAction箭头x坐标
		 */
		arrowX = anchorRect.centerX();
		if(arrowX<0){
			arrowX = 0;
		}
		else if(arrowX>screenWidth){
			arrowX = screenWidth;
		}
	...
	private void showArrow(int whichArrow, int requestedX) {
        ...
        else if(requestedX==screenWidth){
        	requestedX -= arrowWidth / 2;
        }
        param.leftMargin = requestedX - xPos - arrowWidth / 2;
        Log.i("lefyMargin", param.leftMargin+"");
